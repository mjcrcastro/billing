...
Route::get('reports/getSelectedReport',array('as'=>'reports.getSelected','uses'=>'ReportsController@getSelected'));
Route::get('reports/selected',array('as'=>'reports.selected','uses'=>'ReportsController@selectedReport'));
